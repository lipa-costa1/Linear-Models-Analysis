...
###########  modelo já com o diagnóstico inicial aplicado, aplicando ###########
###########    a escolha por Best Subsets e retirando os outliers    ###########
###########            i.e. basta fazer CTRL+A e correr              ###########


###########  Imputação: aqui está o código para realizar a imputação ############
#
# for (X in c(2:20)) {
...
out=boxplot(life)$out         #diagonóstico inicial, retira os outliers iniciais 
...
which(best.fitbic)+1
best.fitbic<-c(1,3,4,6,9,10,12,14,19,20) #já inclui a variável country

best.fitbic<-c(1,3,4,6,9,12,14,19,20) #já sem a infant.deaths, que era desnecessária por ter problemas claros de multicolinearidade
...
########## já passa as suposições, continuar para obter PRESS finito ###########
